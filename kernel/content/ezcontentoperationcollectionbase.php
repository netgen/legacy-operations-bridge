...
/**
 * This is copy as-is of the original eZContentOperationCollection class, used as base for override.
 *
 * @see \eZContentOperationCollection
 */
class eZContentOperationCollectionBase
{
    /**
